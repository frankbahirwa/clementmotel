  ...
  return (
    <section className="relative section-padding overflow-hidden bg-zinc-50">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-4xl mx-auto mt-10 mb-8 p-8 bg-white/80 rounded-[32px] border border-zinc-100 shadow-lg flex flex-col md:flex-row items-center justify-between gap-8 backdrop-blur-md">
